...
# skip connection
input_ = tf.keras.layers.Input(shape=(256, 256, n_kernel))
...
# reconstruction_model.add(tf.keras.layers.Conv2D(n_kernel, (3,3), padding="same", activation="relu"))
...
# end of file, version: 08:38 04.01.2024
